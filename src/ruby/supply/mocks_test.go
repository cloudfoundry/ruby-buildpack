...
func (_mr *MockVersionsMockRecorder) HasWindowsGemfileLock() *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "HasWindowsGemfileLock", reflect.TypeOf((*MockVersions)(nil).HasWindowsGemfileLock))
}
...
func (_mr *MockVersionsMockRecorder) Gemfile() *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "Gemfile", reflect.TypeOf((*MockVersions)(nil).Gemfile))
}
